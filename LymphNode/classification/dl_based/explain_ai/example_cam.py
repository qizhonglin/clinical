...
def get_args():
    ...
    parser.add_argument(
        '--image-path',
        type=str,
        default='/home/qzlin/Downloads/both.png',
...
if __name__ == '__main__':
    ...
    model = models.resnet18(pretrained=True).to(torch.device(args.device)).eval()
    ...
    shutil.copy(args.image_path, os.path.join(args.output_dir, Path(args.image_path).name))
